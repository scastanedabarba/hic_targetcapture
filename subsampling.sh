...
R1=../03.5_subsamples_reads/${base}_R1.fastq
R2=../03.5_subsamples_reads/${base}_R2.fastq
echo $R1
echo $R2
...
do
    ...
    do
        ...
        seed=$RANDOM
        outR1=../03.5_subsamples_reads/subsampled/${base}_${depth}_${trial}_R1.fastq
        outR2=../03.5_subsamples_reads/subsampled/${base}_${depth}_${trial}_R2.fastq
