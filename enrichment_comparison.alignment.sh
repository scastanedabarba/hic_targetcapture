...
echo $library
base=$(basename $library _1.fastq.gz)
echo $base

#specify paths to input and output files
genome=../02_ref_genomes/combined_genomes.fasta #bwa indexed reference genomes
R1_in=${base}_1.fastq.gz #R1
R2_in=${base}_2.fastq.gz #R2
R1_trimmed=../03_trimmed_reads/${base}_1.fastq.gz #trimmed R1
R2_trimmed=../03_trimmed_reads/${base}_2.fastq.gz #trimmed R2
